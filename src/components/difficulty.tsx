export const Difficulty = ({
  ...
  return (
    <fieldset>
      <legend>Please select difficulty level</legend>
      <div className='flex items-center justify-center mb-4 w-100 '>
        <input
          type='radio'
          name='level'
          value='EASY'
        ...
        />
        <label htmlFor='easy' className='ml-2 text-sm font-medium text-gray-900 dark:text-gray-300'>
          EASY
        </label>
      </div>
      ...
      <div className='flex items-center justify-center mb-4 w-100'>
        <input
          ...
          className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600'
        />
        <label htmlFor='hard' className='ml-2 text-sm font-medium text-gray-900 dark:text-gray-300'>
          HARD
        </label>
      </div>
    </fieldset>
